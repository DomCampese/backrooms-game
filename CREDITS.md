...
The Level 0 — "Threshold", Manila Room and Red Rooms entries were added, and the Level 1 row revised, on September 25, 2026. The Level 0 row and the photograph note were extended for the multi-storey Level 0 on September 26, 2026. The wiki
...
| [Level 1 — Habitable Zone](https://backrooms-wiki.wikidot.com/level-1) | Current article by **Praetor3005** and **DivineAtlas**. Its history credits **EnderMitten** for the concept, **u/ThePizzaEater1000** for the original Wikidot article, and **etoisle** for an earlier rewrite. | The basis of Level 1, now shown on the title card as "Level 1 · Habitable Zone". From the article: a sprawling concrete warehouse with exposed rebar (spalled columns and walls with the bars showing), "a low-hanging fog with no discernable source" (drifting ground mist) that "coalesces into condensation, forming puddles … in inconsistent areas" (real puddles on about 1–3% of the floor instead of a sheen on all of it), and dim fluorescent lights that "flicker and fail at inconsistent intervals" (warehouse tube battens, three in ten dead, a fifth stuttering). Also from the article: its "staircases, elevators" (shut lift doors with a lit call button), the steady water and electricity (service pipes along the ceiling), and supply crates that "appear and disappear randomly" with vital and nonsensical contents from the article's own list (openable crates that move after every blackout). Exits are "doors with unique symbols at the end of corridors with fluorescent lights": steel doors, each with its own painted glyph under a caged lamp. The layout, loading docks, safety edging, damp band, the Smiler and progression are the game's own. |
...
through the CC0 texture set listed below. That it was taken a storey up, on the building's second floor,
is the other half of why Level 0 has storeys.
